...
with open("M8/CSVfiles/CSV_A_k3=64", "w", newline='') as file:
    writer = csv.writer(file)
    writer.writerows([A])
with open ("M8/CSVfiles/CSV_E_k3=64", "w",newline='') as file:
    writer = csv.writer(file)
    writer.writerows([E])
...
plt.grid()
#plt.xlim(7.5,20)
plt.savefig("M8/Plots/M8plot_k3=64.pdf")
plt.show()
