...
with open("Models/M5/CSVfiles/CSV_A_k3=64.csv", "w", newline='') as file:
    writer = csv.writer(file)
    writer.writerows([A])
with open ("Models/M5/CSVfiles/CSV_E_k3=64.csv", "w",newline='') as file:
    writer = csv.writer(file)
    writer.writerows([E])
...
plt.grid()
plt.xlim(7.5,20)
plt.savefig("Models/M5/Plots/M5plot_k3=64.pdf")
plt.show()
